...
import HotelResults from '../../components/destinationFilters/hotelResults';
import PoisResults from '../../components/destinationFilters/poisResults';
import ToursResults from '../../components/destinationFilters/toursResults';
import './destinations.styles.scss';
import {fetchPointsOfInterest, fetchToursAndActivities, fetchHotels} from '../../components/axios/axiosRequests';
...
const DestinationsPage = () => {
    ...
    const search = (budgetValue, dateRange, selectedRadioButton, addressCoords) => {
        ...
        if(selectedRadioButton === 'pointsOfInterest') {
            fetchPointsOfInterest(addressCoords).then((response) => {
                setData(response);
            ...
            fetchToursAndActivities(addressCoords).then((response) => {
                setData(response);
                setLoadingIndicator(false);
                setShowTours(true);
            }).catch((error) => {
